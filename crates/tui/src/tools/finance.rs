...
impl Default for FinanceEndpoints {
    fn default() -> Self {
        Self {
            quote_base: crate::env_alias::var("HAMMERSTEIN_FINANCE_QUOTE_BASE_URL", "DEEPSEEK_FINANCE_QUOTE_BASE_URL")
                .unwrap_or_else(|_| "https://query1.finance.yahoo.com/v7/finance/quote".into()),
            chart_base: crate::env_alias::var("HAMMERSTEIN_FINANCE_CHART_BASE_URL", "DEEPSEEK_FINANCE_CHART_BASE_URL")
