//! Project context loading for Hammerstein TUI.
//!
...
fn auto_generate_context(workspace: &Path) -> Option<String> {
    ...
    let content = format!(
        "# Project Structure (Auto-generated)\n\n\
         > This file was automatically generated by Hammerstein TUI.\n\
...
This file provides guidance to AI agents (Hammerstein TUI, Claude Code, etc.) when working with code in this repository.
