...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::HomeDashboardTitle => "Hammerstein TUI Home Dashboard",
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Hammerstein TUI ホームダッシュボード",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Hammerstein TUI 主面板",
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Painel Inicial do Hammerstein TUI",
