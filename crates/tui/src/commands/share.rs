...
<title>Hammerstein TUI Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by Hammerstein TUI · https://github.com/lerugray/hammerstein-tui
</div>
</body>
</html>"#,
    )
...
async fn upload_gist(path: &Path) -> Result<String, String> {
    let output = tokio::process::Command::new("gh")
        .args([
            ...
            "session-export.html",
            "--desc",
            "Hammerstein TUI Session Export",
        ])
        .output()
        .await
...
mod tests {
    ...
    fn test_render_session_html_basic_structure() {
        ...
        assert!(html.contains("Hammerstein TUI"));
    }
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/lerugray/hammerstein-tui"));
    }
}
